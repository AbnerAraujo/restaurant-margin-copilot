...
// holds the 2024-08-01..2026-08-14 synthetic history from
...
// TestHandlePlatformComparison_MatchesFixtureReferenceValuesForKnownPeriod
// verifies the same independently-computed 14-day fixture figures
// internal/mcptools.TestComparePlatformEconomics_MatchesFixtureReferenceValues
...
// equal the fixture window, since this Postgres instance may now hold a much
// larger real data range than just the 14-day fixture.
func TestHandlePlatformComparison_MatchesFixtureReferenceValuesForKnownPeriod(t *testing.T) {
	_, q := httpapiConnectOrSkip(t)

	req := httptest.NewRequest(http.MethodGet, "/api/platforms?start=2026-08-01&end=2026-08-14", nil)
	rec := httptest.NewRecorder()
	HandlePlatformComparison(q)(rec, req)
